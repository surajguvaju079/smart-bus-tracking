...
export default function AdminDashboard() {
  ...
  const renderContent = () => {
    switch (currentPage) {
      ...
      case "Routes":
        return <Text style={styles.heading}>Routes Dashboard</Text>;

      case "Payments":
        return <Text style={styles.heading}>Payment Dashboard</Text>;

      case "Fares":
        return <Text style={styles.heading}>Fare Dashboard</Text>;

      case "Reports":
        return <Text style={styles.heading}>Reports Dashboard</Text>;

      case "Settings":
        return <Text style={styles.heading}>Settings Dashboard</Text>;
